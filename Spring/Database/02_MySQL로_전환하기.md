...
다음 문서에서는 같은 앱을 **회사 실무 스택인 MyBatis**로 다시 만들어 보며 JPA와 비교합니다.

---

⬅️ 이전: [01. JPA로 H2 CRUD 완성하기](./01_JPA로_H2_CRUD.md) | ➡️ 다음: [03. JPA vs MyBatis](./03_JPA_vs_MyBatis.md) | 처음으로: [README](./README.md)
